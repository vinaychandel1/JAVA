...
/**
 * Servlet implementation class Demoimage
 */
@WebServlet(
		urlPatterns = { "/Demoimage" }, 
		initParams = { 
				@WebInitParam(name = "image", value = "file:///D:/workspace3/project1/WebContent/image.jpg")
		})
public class Demoimage extends HttpServlet {
